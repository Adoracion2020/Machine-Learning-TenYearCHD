...
medias14<-cruzadaSVMbin(data=data, vardep="TenYearCHD",listvars=modelo2,
                       ...
                       C=1)
# 
medias14$modelo="SVM_1"
#
medias15<-cruzadaSVMbin(data=data, vardep="TenYearCHD",listvars=modelo2,
                        grupos=4,sinicio=1234,repe=5,
                        C=10)
# 
medias15$modelo="SVM_2"
#
#
medias16<-cruzadaSVMbin(data=data, vardep="TenYearCHD",listvars=modelo2,
                        grupos=4,sinicio=1234,repe=5,
                        C=100)
# 
medias16$modelo="SVM_3"
# 
...
# 
medias18$modelo="SVMPoly_2"
# Un poco de mejora de sesgo, pero aumenta aun mas la varianza y siguen siendo valores muy malos
medias19<-cruzadaSVMbinPoly(data=data, vardep="TenYearCHD",listvars=modelo2,
                            grupos=4,sinicio=1234,repe=5,
                            C=0.05,degree=1,scale=5)
# 
medias19$modelo="SVMPoly_3"
#
...
medias20<-cruzadaSVMbinRBF(data=data, vardep="TenYearCHD",listvars=modelo2,
   ...
   C=4,sigma=0.2)
# 
medias20$modelo="SVMRBF"

medias21<-cruzadaSVMbinRBF(data=data, vardep="TenYearCHD",listvars=modelo2,
                           grupos=4,sinicio=1234,repe=5,
                           C=5,sigma=0.2)
# 
medias21$modelo="SVMRBF_2"
# Aumenta mucho la varianza con respecto a los otros tuneados
medias22<-cruzadaSVMbinRBF(data=data, vardep="TenYearCHD",listvars=modelo2,
                           grupos=4,sinicio=1234,repe=5,
                           C=10,sigma=0.2)
# 
medias22$modelo="SVMRBF_3"
# 
# Comparamos logistica con SVM (Linear, polinomial y Gauss)
union1<-rbind(medias1,medias14,medias15,medias16,medias17,medias18,medias19,medias20,medias21,medias22)
# mejor: medias19 
par(cex.axis=0.8)
boxplot(data=union1,tasa~modelo,main="TASA FALLOS")
boxplot(data=union1,auc~modelo,main="AUC")
